...
use crate::{util::row::*, version_control::diff::*, user::userdata::User};
...
pub fn delete_table(table_name: &String, database: &Database, user: &User) -> Result<TableRemoveDiff, String> {
