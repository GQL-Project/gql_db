...
mod tests {
    ...
    fn test_basic_merge() {
        ...
        rows.push(vec![Value::I32(100), Value::String("SecondRow".to_string())]);
        ...
        if let Diff::Remove(remove_diff) = &merge_diffs[1] {
    ...
    fn test_squash() {
        ...
        let squash: Commit = get_db_instance()
            .unwrap()
            .get_commit_file_mut()
            .squash_commits(&vec![commit1, commit2], false)
            .unwrap();
