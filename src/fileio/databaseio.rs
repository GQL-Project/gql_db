...
impl Database {
    ...
    pub fn new(database_name: String) -> Result<Database, String> {
        ...
        std::fs::File::create(&branch_heads_file_path)
            .map_err(|e| "Database::new() Error: ".to_owned() + &e.to_string())?;
    ...
    pub fn create_branch(&mut self, _branch_name: String) -> Result<(), String> {
        // TODO: implementation
        Ok(())
    }
